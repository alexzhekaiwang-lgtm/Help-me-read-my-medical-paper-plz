...
- Identify the paper, version, source status (for example published, preprint, or explicitly fictional/synthetic), access route, study type, species or population, intervention or exposure, outcomes, and available supplements.

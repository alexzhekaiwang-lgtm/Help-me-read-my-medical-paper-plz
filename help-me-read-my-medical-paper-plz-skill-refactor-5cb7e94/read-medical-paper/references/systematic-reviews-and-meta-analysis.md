...
Use when a paper reports an explicit systematic search and study-selection process, with or without quantitative pooling. Route narrative reviews without systematic methods through [study-design-routing.md](study-design-routing.md) instead.

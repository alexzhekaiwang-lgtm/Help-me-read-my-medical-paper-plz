...
Use when the design is unclear, mixed, or itself under discussion. When the design is already known, proceed directly to the relevant design reference.
...
1. Are participants assigned by investigators to an intervention?
   ...
   - Nonrandom assignment or no concurrent control: nonrandomized or single-arm interventional trial. Use [clinical-trials.md](clinical-trials.md); identify phase, allocation method, dose/escalation design, and whether the comparator is concurrent, historical, or absent. Add [observational-studies.md](observational-studies.md) when comparisons are nonrandomized.
